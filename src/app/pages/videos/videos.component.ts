...
export class VideosComponent implements OnInit {
  videos = [ 
    { id: 'CFBLt_IQkig', title: 'Challange 7: kursdagi barcha o\'tilgan mavzulardan foydalanib Instagram loyihasi', type: 'F' },
    { id: 'IYsp_-03zDU', title: 'Challange 7: kursdagi barcha o\'tilgan mavzulardan foydalanib Instagram loyihasi', type: 'F' },
    { id: 'pKIWKzHpMjs', title: 'Challange 6: kursdagi barcha o\'tilgan mavzulardan foydalanib Instagram loyihasi', type: 'F' },
    { id: 'u-zX_yH41C8', title: 'Challange 5: kursdagi barcha o\'tilgan mavzulardan foydalanib Instagram loyihasi', type: 'F' },
    { id: 'CDVJ34P2X-s', title: 'Challange 4: kursdagi barcha o\'tilgan mavzulardan foydalanib Instagram loyihasi', type: 'F' },
    ...
    { id: 'O6Danzfjgzk', title: 'LIST CRUD: For/List/While qaytarish, List CRUD bo\'yicha loyichacha ', type: 'F' },
    { id: 'EUkfJ9MYp8s', title: 'Telegram bot: FLashcart, Lug\'at, Mashg\'ulot va User login', type: 'C#' },
    ...
    { id: 'fmDsboikP24', title: 'Authentication: Copy/Paste qilish orqali, JWT token', type: 'A' },
    { id: 'xgy3u7egzG8', title: 'Takrorlash: Frontend, HTML, CSS va boshqalarni qaytarish', type: 'C++' },
    { id: 'y9f3QRiMtOQ', title: 'JWT Token: Logindan keyin JWT token generatsiya qilish', type: 'A' },
    { id: 'ktL-VmVIoJk', title: 'HashPassword: parollarni xavfsizligini kuchaytirish', type: 'A' },
    { id: '6CgvPIU4hD8', title: 'Scss: Angularda CSS o\'rniga SASSdan foydalanish', type: 'A' },
    { id: '9kt7CENqfBY', title: 'Full-Stack: Errorisiz Authorization & Authentification', type: 'A' },
    ...
    { id: 'dFI1vvwFtzc', title: 'Integration: Frontend UI va Backend API ulash (FULL)', type: 'A' },
  ...
  filterVideos(category: string): void {
    ...
    if (category === 'All') {
      ...
      this.filteredVideos = this.videos.filter(video => video.type === category);
    }
  }
  ...
  searchVideos(event: Event): void {
    ...
    if (searchTerm === '') {
      this.filterVideos(this.activeCategory);
    } else {
